...
public class PluginStreamReader {
    ...
    public PluginStreamReader(InputStream stream) {
        this.stream = stream;
    }

    public Plugin readPlugin() throws IOException {
    ...
    public void loadDepends(Plugin plugin, AsyncCollectionResult<CollectionEventStore, Set<CollectionEventStore>> event) {
        ...
        eventStoreSet.parallelStream().forEach(e -> e.store.node.getClasses(e));
    }
